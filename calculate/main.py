...
sum_total = num_potatoes * potato + num_leeks * leek + num_broccolis * broccoli + num_brussel_sprouts * brussel_sprout

discount_percentage = 30
discounted_sum_total = (1-discount_percentage/100) * sum_total